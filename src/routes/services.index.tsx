...
import { ArrowRight, Building2, Hospital, Brain, House, Phone, MessageCircle, Check } from "lucide-react";
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Care Packages with Pricing — Priyojon Care" },
      {
        ...
        content: "Choose a structured plan that fits your family's budget and your loved one's needs.",
      },
    ],
  }),
  ...
  return (
    <div className="bg-surface">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-accent via-background to-surface">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-16 lg:pt-24 pb-10">
      ...
      <section className="bg-foreground text-background py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="font-bangla text-background/80 mb-2">আমাদের কেয়ার অ্যাডভাইজার আপনাকে সাহায্য করবেন।</p>
          <p className="text-background/70 mb-7 max-w-xl mx-auto">
            Talk to a care advisor — we'll listen, suggest the right plan, and confirm pricing offline. No payment
            online, ever.
          </p>
