...
import { V as createLucideIcon, f as Button, L as Link, ai as whatsappLink, u as Stethoscope, d as ArrowRight, S as SERVICES, a6 as serviceLinkProps, s as SITE, z as callLink, P as Phone } from "./router-C3WBn37j.js";
...
const HeartHandshake = createLucideIcon("heart-handshake", __iconNode$1);
const __iconNode = [
...
const VIDEOS = [{
  ...
  thumb: "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?auto=format&fit=crop&w=1200&q=80"
}, {
  id: "aqz-KE-bpKQ",
  title: "Our Caregivers",
  desc: "Trained, certified and compassionate — meet the team.",
  thumb: "https://images.unsplash.com/photo-1551601651-2a8555f1a136?auto=format&fit=crop&w=1200&q=80"
}];
const COUNTERS = [{
  icon: Users,
  value: 3e3,
...
function Counter({
  ...
  const [text, setText] = reactExports.useState(`0${suffix}`);
  reactExports.useEffect(() => {
    if (!inView2) return;
  ...
  }, [inView2, to, mv, rounded, suffix]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { ref, children: text });
}
function VideoCard({
  v
}) {
  const [playing, setPlaying] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "group relative aspect-video rounded-2xl overflow-hidden bg-foreground/5 border border-border shadow-card", children: playing ? /* @__PURE__ */ jsxRuntimeExports.jsx("iframe", { src: `https://www.youtube.com/embed/${v.id}?autoplay=1&rel=0`, title: v.title, allow: "autoplay; encrypted-media; picture-in-picture", allowFullScreen: true, className: "w-full h-full" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setPlaying(true), className: "absolute inset-0 block w-full h-full text-left", "aria-label": `Play ${v.title}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: v.thumb, alt: v.title, loading: "lazy", className: "w-full h-full object-cover" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-16 rounded-full bg-background/95 flex items-center justify-center shadow-elegant group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "size-7 text-primary fill-primary ml-1" }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute left-5 right-5 bottom-5 text-background", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block font-display text-lg font-bold", children: v.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-sm text-background/80 mt-1", children: v.desc })
    ] })
  ] }) });
}
const ICONS = {
...
function HomePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative bg-gradient-hero overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeroSlider, { images: HERO_IMAGES.home }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-12 lg:py-18 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        opacity: 0,
        y: 20
      }, animate: {
        opacity: 1,
        ...
        duration: 0.6
      }, className: "lg:col-span-6 flex flex-col gap-7", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-primary", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-6 h-px bg-primary" }),
          " Dhaka's Trusted Senior Care"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.15] text-balance", children: [
          "আপনার প্রিয়জনের যত্ন,",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "এখন আপনার কাছেই" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-[55ch] leading-relaxed", children: "Doctor-supervised caregivers bringing structured medical protocols and deep compassion to your home — so your parents can age with dignity surrounded by family." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "lg", className: "shadow-cta", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/request", children: "Request Care Plan" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "outline", size: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: whatsappLink("Hi! I'd like to talk to a Care Advisor."), target: "_blank", rel: "noopener noreferrer", className: "gap-2 text-black !text-black", children: "Talk to Care Advisor" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-7 border-t border-border flex flex-wrap gap-x-7 gap-y-3", children: [{
          icon: ShieldCheck,
          ...
          icon: Clock,
          label: "24/7 Support"
        }].map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm font-medium text-black !text-black", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(b.icon, { className: "size-4 text-primary" }),
          " ",
          b.label
        ] }, b.label)) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 lg:py-28 bg-surface", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold tracking-tight", children: "Structured Care Pathways" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-3 max-w-xl", children: "Tailored care plans for every stage — from daily companionship to critical ICU support at home." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "outline", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/services", children: [
          "View all services ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "size-4 ml-2" })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4", children: SERVICES.map((s, i) => {
        ICONS[s.icon];
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          ...
          duration: 0.4,
          delay: i * 0.08
        }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { ...serviceLinkProps(s.slug), className: "group relative block overflow-hidden rounded-xl border border-border bg-background hover:border-primary hover:shadow-card transition-all h-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-40 w-full overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: SERVICE_IMAGES[s.slug] ?? SERVICE_IMAGES.residences, alt: s.title, loading: "lazy", className: "absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/20 group-hover:bg-black/30 transition" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-lg mb-1.5 text-foreground", children: s.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bangla text-xs text-primary mb-3", children: s.bangla }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-4", children: s.tagline })
          ] })
        ] }) }, s.slug);
      }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 lg:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 max-w-2xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl lg:text-4xl font-bold", children: [
          "How ",
          SITE.name,
          " works"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-3", children: "No checkout, no instant booking. We listen first, then match the right caregiver." })
      ] }),
      ...
      }].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7 rounded-xl border border-border bg-surface", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold text-primary tabular-nums mb-3", children: s.n }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-primary text-xl mb-2", children: s.t }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-black text-sm leading-relaxed", children: s.d })
      ] }, s.n)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 lg:py-20 bg-gradient-to-br from-primary/5 via-background to-accent/20 border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8", children: COUNTERS.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      opacity: 0,
      y: 16
    }, whileInView: {
      opacity: 1,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-14 rounded-2xl bg-primary/10 flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(c.icon, { className: "size-7 text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-4xl lg:text-5xl font-bold tabular-nums text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Counter, { to: c.value, suffix: c.suffix }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold mt-2", children: c.label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bangla text-xs text-muted-foreground mt-0.5", children: c.bn })
    ] }, c.label)) }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 lg:py-28 bg-surface", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold tracking-tight", children: "Moments from our homes" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bangla text-muted-foreground mt-3", children: "প্রতিদিনের জীবন, যত্ন ও আনন্দের ছোট ছোট মুহূর্ত" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 lg:gap-4", children: GALLERY.map((g, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        opacity: 0,
        scale: 0.96
      }, whileInView: {
        opacity: 1,
        ...
        duration: 0.45,
        delay: i % 4 * 0.06
      }, className: `relative overflow-hidden rounded-2xl bg-muted group ${i === 0 || i === 5 ? "row-span-2 aspect-[3/4] md:aspect-auto" : "aspect-square"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: g.src, alt: g.caption, loading: "lazy", className: "w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-foreground/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-4 bottom-4 right-4 text-background text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity", children: g.caption })
      ] }, g.src)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 lg:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl mx-auto mb-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold tracking-tight", children: "See care in action" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bangla text-muted-foreground mt-3", children: "আমাদের যত্ন, পরিবার ও কেয়ারগিভারদের গল্প" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-5 md:grid-cols-2 lg:grid-cols-3", children: VIDEOS.map((v, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
        opacity: 0,
        y: 20
      }, whileInView: {
        opacity: 1,
        ...
        duration: 0.5,
        delay: i * 0.1
      }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(VideoCard, { v }) }, v.id)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 lg:py-28 bg-surface border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl mx-auto mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-primary mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-6 h-px bg-primary" }),
          " Why families trust us"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold tracking-tight", children: "Built on trust, safety and dignity" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-3", children: "Four commitments that guide every decision we make for your family." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-5 sm:grid-cols-2 lg:grid-cols-4", children: TRUST_PILLARS.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        opacity: 0,
        y: 16
      }, whileInView: {
        opacity: 1,
        ...
        duration: 0.45,
        delay: i * 0.08
      }, className: "p-6 rounded-2xl bg-background border border-border hover:border-primary/40 hover:shadow-card transition-all", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-12 rounded-xl bg-primary/10 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(p.icon, { className: "size-6 text-primary" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 lg:py-28 bg-foreground text-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "size-6 text-warning mx-auto mb-6 fill-warning" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("blockquote", { className: "font-display text-2xl md:text-3xl font-medium leading-relaxed text-pretty", children: `"When my father had his stroke, the nurse from Priyojon didn't just bring clinical expertise — she brought a profound calm to our entire household. I could finally breathe."` }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex flex-col items-center gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Farah Rahman" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-background/60", children: "Gulshan, Dhaka" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 lg:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold mb-4", children: "Ready to give your parents the care they deserve?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-8 max-w-xl mx-auto", children: "Speak to a care advisor today. No obligations, no online payments — just a conversation about what your family needs." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "lg", className: "shadow-cta", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/request", children: "Request Care" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "outline", size: "lg", className: "gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: callLink, children: [
